...
public class CountingCharactersInstructorVer {
    public static void main(String[] args) {
        ...
        charCounts= (countOccurrences(charCounts,testStr,0));
    ...
    //Let's use Recursion!
    private static HashMap<Character, Integer> countOccurrences(HashMap<Character, Integer> charCounts, String someString, int index) {
        ...
        return countOccurrences(charCounts, someString, index+1);
    }
}
